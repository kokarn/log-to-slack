...
apache2.prototype.serviceName = 'apache2';
apache2.prototype.serviceIcon = 'http://i.imgur.com/4cCZiwS.png';
...
apache2.prototype.handleMessage = function( message ){
...
apache2.prototype.getLastMessages = function( callback ){
    ...
    this.runCommand( this.logCommand + ' ' + this.messageCount, function( messageBuffer ){
        _this.handleMessage( String( messageBuffer ));
    });
};
